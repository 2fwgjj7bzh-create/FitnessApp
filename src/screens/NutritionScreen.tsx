...
const mStyles = StyleSheet.create({
  ...
  tabs: { flexDirection: 'row', backgroundColor: colors.card, borderRadius: borderRadius.md, padding: 3, marginBottom: spacing.md },
  tabBtn: { flex: 1, paddingVertical: 8, borderRadius: borderRadius.sm, alignItems: 'center' },
  tabActive: { backgroundColor: colors.primary },
  tabText: { ...typography.label, color: colors.textSecondary },
  tabActiveText: { color: colors.text, fontWeight: '600' },
  searchInput: {
    backgroundColor: colors.inputBg, borderRadius: borderRadius.md,
